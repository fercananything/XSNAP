...
Usage formula:
    >>> make-region <evtfile> <ra> <dec> [r_in] [r_out] [outdir] [--ds9 DS9_PATH] [--expimg EXP_IMG]

Usage examples: 
    >>> make-region /path/to/event.fits 169.532 -32.456
    >>> make-region /path/to/event.fits --expimg /path/to/exposure.img 169.532 -32.456
    >>> make-region /path/to/event.fits --expimg /path/to/exposure.img 169.532 -32.456 25 150 ./output/
